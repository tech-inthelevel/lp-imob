  ...
  return (
    <section className="imob-feature-ai">
      <div className="imob-feature-ai__card" data-fx="zoom-in">
        <img className="imob-feature-ai__line" style={{ left: '55.174%', top: '-5.729%', width: '33.403%', height: '55.208%' }} src="/assets/imob/ai-line-top.svg" alt="" aria-hidden="true" loading="lazy" decoding="async" />
        <img className="imob-feature-ai__line imob-feature-ai__line--flip" style={{ left: '55.174%', top: '51.042%', width: '33.403%', height: '55.208%' }} src="/assets/imob/ai-line-bottom.svg" alt="" aria-hidden="true" loading="lazy" decoding="async" />
        <img className="imob-feature-ai__line imob-feature-ai__line--flip" style={{ left: '33.785%', top: '51.323%', width: '76.181%', height: '50%' }} src="/assets/imob/ai-line-mid-flip.svg" alt="" aria-hidden="true" loading="lazy" decoding="async" />
        <img className="imob-feature-ai__line" style={{ left: '33.785%', top: '0.021%', width: '76.181%', height: '50.26%' }} src="/assets/imob/ai-line-mid.svg" alt="" aria-hidden="true" loading="lazy" decoding="async" />
        ...
        <span className="imob-feature-ai__pill imob-feature-ai__pill--instagram" style={{ left: '78.65%', top: '72.4%' }}>
          <img src="/assets/imob/icon-instagram.svg" alt="" aria-hidden="true" loading="lazy" decoding="async" />
          Instagram
        </span>
        <span className="imob-feature-ai__pill imob-feature-ai__pill--sms" style={{ left: '60.66%', top: '64.06%' }}>
          <img src="/assets/imob/icon-sms.svg" alt="" aria-hidden="true" loading="lazy" decoding="async" />
          SMS
        </span>
        <span className="imob-feature-ai__pill imob-feature-ai__pill--bolt" style={{ left: '80.03%', top: '41.93%' }}>
          <img src="/assets/imob/icon-bolt.svg" alt="" aria-hidden="true" loading="lazy" decoding="async" />
          8s
        </span>

        <div className="imob-feature-ai__text">
          <div className="imob-feature__icon" aria-hidden="true">
            <img src="/assets/imob/icon-message-square.svg" alt="" loading="lazy" decoding="async" />
          </div>
